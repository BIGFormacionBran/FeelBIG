        ...
        <div class="admin-card side-form" data-entity="Contenido">
            ...
            <form method="POST" id="content-form">
                ...
                <div class="form-group">
                    ...
                    <div class="file-selector-display">
                        <input type="text" name="imagen" id="con-imagen" readonly placeholder="Ningún archivo seleccionado">
                ...
                <div class="form-group">
                    ...
                    <div class="file-selector-display">
                        <input type="text" name="video" id="con-video" readonly placeholder="Ningún archivo seleccionado">
