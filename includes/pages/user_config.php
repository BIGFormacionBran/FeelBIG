        ...
        <div class="login-central-container">
            <form action="includes/actions/update_user.php" method="POST">
                ...
                <div class="input-box">
                    ...
                    <input type="text" name="nombre" placeholder="<?php echo htmlspecialchars($userData['nombre'] ?? ''); ?>">
                </div>

                <div class="input-box">
                    <label>Correo Electrónico</label>
                    <input type="email" name="correo" placeholder="<?php echo htmlspecialchars($userData['correo'] ?? ''); ?>">
                </div>
                ...
                <div class="input-box">
                    ...
                    <button type="button" class="btn-ojo" id="toggleBtn" aria-label="Mostrar contraseña">
                        ...
                        <svg class="icon-closed" viewBox="0 0 24 24" fill="currentColor">
